...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldGroupID, apikey.FieldIdempotencyRecordID:
...
func (_m *APIKey) String() string {
	...
	builder.WriteString(", ")
	if v := _m.IdempotencyRecordID; v != nil {
