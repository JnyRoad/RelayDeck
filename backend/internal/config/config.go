...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "relaydeck")
	...
	viper.SetDefault("webauthn.rp_display_name", "RelayDeck")
	...
	viper.SetDefault("database.dbname", "relaydeck")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "relaydeck:")
