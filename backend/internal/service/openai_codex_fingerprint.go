...
func resolveConvergedInstallationID(account *Account, seed string) string {
	...
	return deriveStableUUIDv4("relaydeck:codex-install-id:v2:" + seed)
}
...
func resolveConvergedSessionID(seed string) string {
	...
	return deriveStableUUIDv4("relaydeck:codex-session-id:v2:" + seed)
}
...
func resolveConvergedThreadID(seed, clientSessionID string) string {
	...
	return deriveStableUUIDv4("relaydeck:codex-thread-id:v2:" + seed + ":" + clientSessionID)
}
