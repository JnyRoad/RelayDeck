...
func compactProbeSessionID(accountID int64) string {
	if accountID <= 0 {
		return deriveStableUUIDv4("relaydeck:codex-compact-probe:v1:anonymous")
	}
	return deriveStableUUIDv4("relaydeck:codex-compact-probe:v1:" + strconv.FormatInt(accountID, 10))
}
