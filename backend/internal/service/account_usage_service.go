...
import (
	...
	httppool "github.com/JnyRoad/RelayDeck/internal/pkg/httpclient"
	openaipkg "github.com/JnyRoad/RelayDeck/internal/pkg/openai"
...
type UsageLogRepository interface {
	...
	GetBatchAPIKeyUsageStats(ctx context.Context, apiKeyIDs []int64, userID int64, startTime, endTime time.Time) (map[int64]*usagestats.BatchAPIKeyUsageStats, error)
