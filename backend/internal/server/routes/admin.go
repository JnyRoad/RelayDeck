...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.POST("/app-server/login/start", h.Admin.OpenAIOAuth.StartAppServerLogin)
		openai.GET("/app-server/login/:session_id", h.Admin.OpenAIOAuth.GetAppServerLogin)
		openai.POST("/app-server/login/:session_id/cancel", h.Admin.OpenAIOAuth.CancelAppServerLogin)
		openai.POST("/app-server/login/:session_id/create-account", h.Admin.OpenAIOAuth.CreateAppServerAccount)
