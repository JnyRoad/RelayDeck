...
assert_line Dockerfile.goreleaser 'COPY --chown=relaydeck:relaydeck backend/resources /app/resources'
assert_line deploy/Dockerfile 'COPY --from=backend-builder --chown=relaydeck:relaydeck /app/backend/resources /app/resources'
