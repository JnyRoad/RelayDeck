export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your RelayDeck Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your RelayDeck Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your RelayDeck Grok group.',
        configTomlHint:
        ...
        codexConfigTomlHint:
          'Official Codex: wire_api = "responses" only; prefer env_key over experimental_bearer_token; supports_websockets = false for non-OpenAI gateways (RelayDeck can still accept client WS and bridge to HTTP/SSE). Back up ~/.codex/config.toml before merge.',
        note:
        ...
        codexNote:
          'Export RELAYDECK_API_KEY, save config.toml under ~/.codex (mkdir -p ~/.codex). Prefer env_key auth; do not commit secrets.',
        codexNoteWindows:
          'Set $env:RELAYDECK_API_KEY, save config.toml under %USERPROFILE%\\.codex. Prefer env_key auth; do not commit secrets.',
      },
      deepseek: {
        ...
        codexNote: 'Export RELAYDECK_API_KEY before starting Codex. The downloaded catalog contains model metadata only, not your API key.',
      },
      composite: {
        ...
        codexConfigTomlHint: 'Download the model catalog below, save both files under the Codex config directory, and restart Codex.',
        codexNote: 'Export RELAYDECK_API_KEY before starting Codex. Model requests are routed by the selected catalog slug.',
      },
      routedCodex: {
        ...
        note: 'Export RELAYDECK_API_KEY before starting Codex. The downloaded catalog contains model metadata only, not your API key.',
      },
      codexModelCatalog: {
