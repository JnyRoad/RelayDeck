...
const GITHUB_REPO = 'JnyRoad/RelayDeck'
// Docker Hub image published by CI (tags carry no "v" prefix, e.g. jnyroad/relaydeck:0.1.146)
const DOCKER_IMAGE = 'jnyroad/relaydeck'
